...
public class QKGExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(QKGDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new QKGStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static QKGDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static QKGDateTimeConverter dateTimeConverter = new QKGStandardDateTimeConverter();

    public QKGExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public QKGExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new QKGMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=QKGHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,QKGExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=QKGHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
