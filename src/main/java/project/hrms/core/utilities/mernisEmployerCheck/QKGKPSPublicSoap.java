...
public class QKGKPSPublicSoap
{
    ...
    public QKGKPSPublicSoap(){}

    public QKGKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public QKGKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        QKGExtendedSoapSerializationEnvelope envelope= new QKGExtendedSoapSerializationEnvelope(QKGExtendedSoapSerializationEnvelope.VER11);
